...
export const GET_RESUMES_BY_CANDIDATE_ID_SUCCESS="GET_RESUMES_BY_CANDIDATE_ID_SUCCESS"
export const GET_RESUMES_BY_CANDIDATE_ID_FAILURE="GET_RESUMES_BY_CANDIDATE_ID_FAILURE"
...
export const DELETE_RESUME_COMPLETELY_SUCCESS="DELETE_RESUME_COMPLETELY_SUCCESS"
export const DELETE_RESUME_COMPLETELY_FAILURE="DELETE_RESUME_COMPLETELY_FAILURE"
...
export const  getResumesByCandidateId=(canidateId)=>async dispatch=>{
    await resumeService.getByCandidateId(canidateId)
    .then(response=>dispatch({
...
export const addResumeImage=(formData)=>async dispatch=>{
    await resumeService.addOrUpdateImage(formData)
...
export const addResumeHead=(resumeHead)=>async dispatch=>{
    await resumeService.addOrUpdateResumeHead(resumeHead)
    .then(result=>dispatch({
...
export const addTalent=(talent)=>async dispatch=>{
    await resumeService.addOrUpdateTalent(talent)
    .then(result=>dispatch({
...
export const addJobExperience=(jobExperience)=>async dispatch=>{
    await resumeService.addOrUpdateJobExperience(jobExperience)
    .then(result=>dispatch({
...
export const addLanguage=(language)=>async dispatch=>{
    await resumeService.addOrUpdateLanguage(language)
    .then(result=>dispatch({
...
export const addWebAdresses=(webAdresses)=>async dispatch=>{
    await resumeService.addOrUpdateWebAddresses(webAdresses)
    .then(result=>dispatch({
...
export const deleteGraduation=(graduationId)=>async dispatch=>{
    await resumeService.deleteGraduation(graduationId)
    .then(response=>dispatch({
...
export const deleteTalent=(talentId)=>async dispatch=>{
    await resumeService.deleteTalent(talentId)
    .then(response=>dispatch({
...
export const deleteJobExperience=(jobExperienceId)=>async dispatch=>{
    await resumeService.deleteJobExperience(jobExperienceId)
    .then(response=>dispatch({
...
export const deleteWebAdresses=(webAddressId)=>async dispatch=>{
    await resumeService.deleteWebAdresses(webAddressId)
    .then(response=>dispatch({
