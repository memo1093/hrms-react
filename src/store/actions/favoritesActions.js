...
export const GET_FAVORITES_BY_CANDIDATE_ID_SUCCESS = "GET_FAVORITES_BY_CANDIDATE_ID_SUCCESS";
export const GET_FAVORITES_BY_CANDIDATE_ID_FAILURE = "GET_FAVORITES_BY_CANDIDATE_ID_FAILURE";
    ...
    await favoriteService
      ...
      .then((response) =>
        ...
        dispatch({
          ...
          payload:{id:response.data.data,jobPositionAdvertisement:jobAdvertisement}
        })
      )
      .catch((error) =>
        dispatch({
